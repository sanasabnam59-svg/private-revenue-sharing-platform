...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    const circuitsObj = {
      claimRevenue: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`claimRevenue: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        ...
        const shareholderKey = (witnesses_0.shareholderSecretKey || witnesses_0.studentSecretKey)({ privateState: contextOrig_0.privateState, ledger: {} })[1];
        return { result: shareholderKey, context };
      },
      submitExam: (...args_1) => circuitsObj.claimRevenue(...args_1),
      resetRevenuePool: (...args_1) => {
        const contextOrig_0 = args_1[0];
        const newRevenueId_0 = args_1[1];
        return { result: newRevenueId_0, context: { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() } };
      },
      resetExam: (...args_1) => circuitsObj.resetRevenuePool(...args_1),
      incrementEpoch: (...args_1) => {
        const contextOrig_0 = args_1[0];
        return { result: [], context: { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() } };
      },
